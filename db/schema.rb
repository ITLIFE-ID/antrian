...
ActiveRecord::Schema[8.0].define(version: 2025_05_11_065041) do
  ...
  create_table "dashboard_details", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.datetime "deleted_at"
    t.index ["company_id"], name: "index_dashboard_details_on_company_id"
    t.index ["dashboard_id"], name: "index_dashboard_details_on_dashboard_id"
    t.index ["deleted_at"], name: "index_dashboard_details_on_deleted_at"
  end
