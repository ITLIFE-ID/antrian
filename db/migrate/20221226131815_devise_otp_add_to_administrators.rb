class DeviseOtpAddToAdministrators < ActiveRecord::Migration[7.0]
  def self.up
    ...
    add_index :administrators, :otp_session_challenge, unique: true
    add_index :administrators, :otp_challenge_expires
  end
